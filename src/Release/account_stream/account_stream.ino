...
void setup() {
  ...
  while (!wifiManager.autoConnect("Account_Monitor")) {
  ...
  // Demo wallet address ** XRMINE DROP WALLET **
  if (strcmp(walletAddress, "") == 0) {
  strcpy(walletAddress, "r3VekZUS7MfnkWiJ131TsGqmKZwvqAyisX");
  }
